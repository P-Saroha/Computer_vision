...
## Image Operations with Pixel Values
import cv2
import numpy as np
"""
#Read an Image---
img = cv2.imread("D:\\Computer Vision\\2. Computer Vision\\CV\\pikachu.jpg")
...
print("Imagetype==",type(img)) # returns Type of image is obtained
...
img = cv2.imread("D:\\Computer Vision\\2. Computer Vision\\CV\\lion.jpg")

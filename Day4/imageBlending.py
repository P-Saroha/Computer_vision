...
img1 = cv2.imread("D:\\Computer Vision\\2. Computer Vision\\CV\\roi_opr.jpg")
img1 = cv2.resize(img1,(500,700))
img2 = cv2.imread("D:\\Computer Vision\\2. Computer Vision\CV\\bro_thor.jpg")
...
result2 = cv2.addWeighted(img1,0.7,img2,0.3,0) # #0 is gama value , 0.7 is weight of img1 and 0.3 is weight of img2
